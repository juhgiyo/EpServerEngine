...
BaseServerUDP::BaseServerUDP(const TCHAR *  port,epl::BaseCallbackObject *callbackObj, epl::LockPolicy lockPolicyType): BaseServerObject(callbackObj,lockPolicyType)
{
