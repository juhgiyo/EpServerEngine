...
BaseClient::BaseClient(const TCHAR * hostName, const TCHAR * port,epl::BaseCallbackObject *callbackObj,epl::LockPolicy lockPolicyType) :BaseServerSendObject(callbackObj,lockPolicyType)
{
